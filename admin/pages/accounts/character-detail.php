 ...
 * Modified to use a two-column layout for Details card and one-column for Others card
 */

// This is a partial code example showing the restructured sections
// The beginning of the file with includes and data fetching remains the same

?>

<!-- This section shows the modified main-content-grid with restructured layout -->
...
<div class="main-content-grid">
        ...
        <div class="admin-card-header">
            ...
            <div class="map-preview-container">
                ...
                <div class="map-coordinates">
                    ...
                    <div class="coordinate-item">
                        <div class="coordinate-label">Position</div>
                        <div class="coordinate-value">
                    ...
                    <div class="coordinate-item">
                        ...
                        <div class="coordinate-value"><?php echo $character['Heading']; ?></div>
                    </div>
                    <div class="coordinate-item">
                        <div class="coordinate-label">Hometown</div>
                        <div class="coordinate-value">
    ...
    <!-- Details Card (Restructured to two-column layout) -->
    <div class="admin-card">
        <div class="admin-card-header">
        ...
        <div class="admin-card-body">
            ...
            <div class="compact-stats">
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?php echo $character['Ac']; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Exp Recovery</div>
                    <div class="detail-value"><?php echo $character['ExpRes']; ?>%</div>
                </div>
            </div>
            ...
            <div class="compact-stats">
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?php echo $character['objid']; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Type</div>
                    <div class="detail-value"><?php echo $character['Type']; ?></div>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?php echo !empty($character['Title']) ? htmlspecialchars($character['Title']) : 'None'; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Access Level</div>
                    <div class="detail-value"><?php echo getAccessLevelName($character['AccessLevel']); ?></div>
                </div>
                <div class="detail-item">
            ...
            <div class="compact-stats">
                <div class="detail-item">
                    <div class="detail-label">Karma</div>
                    <div class="detail-value"><?php echo $character['Karma']; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Last PK</div>
                    <div class="detail-value"><?php echo $character['LastPk'] ? date('M j, Y H:i:s', strtotime($character['LastPk'])) : 'Never'; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Player Kills</div>
                    <div class="detail-value"><?php echo $character['PC_Kill'] ?? 0; ?></div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Player Deaths</div>
                    <div class="detail-value"><?php echo $character['PC_Death'] ?? 0; ?></div>
                </div>
            </div>
        </div>
    </div>
    
    <!-- Others Card (Restructured to one-column vertical layout with map at bottom) -->
    <div class="admin-card">
        <div class="admin-card-header">
        ...
        <div class="admin-card-body">
            ...
            <div class="detail-item">
                ...
                <div class="detail-value"><?php echo $character['lastLoginTime'] ? date('M j, Y H:i:s', strtotime($character['lastLoginTime'])) : 'Never'; ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Last Logout</div>
                <div class="detail-value"><?php echo $character['lastLogoutTime'] ? date('M j, Y H:i:s', strtotime($character['lastLogoutTime'])) : 'Never'; ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Delete Time</div>
                <div class="detail-value">
            ...
            <div class="detail-item">
                <div class="detail-label">Hell Time</div>
                <div class="detail-value"><?php echo $character['HellTime'] ? $character['HellTime'] . ' seconds' : 'None'; ?></div>
            </div>
            <div class="detail-item">
                <div class="detail-label">Birthday</div>
                <div class="detail-value"><?php echo $character['BirthDay'] ? $character['BirthDay'] : 'Not Set'; ?></div>
            </div>
            <div class="detail-item">
